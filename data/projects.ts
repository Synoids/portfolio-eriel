...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      { image: "/homepage-pulse-check.png", title: { en: "Mobile-First Dashboard", id: "Dashboard Mobile-First" }, description: { en: "The main PWA interface providing immediate access to pending complaints.", id: "Antarmuka utama PWA yang memberikan akses instan ke keluhan yang tertunda." } },
