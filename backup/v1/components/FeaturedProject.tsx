...
export default function FeaturedProject() {
  ...
  const featureIcons = [
    <BrainCircuit key="ai" className="w-5 h-5" />,
    <BarChart3 key="analytics" className="w-5 h-5" />,
    <Target key="goal" className="w-5 h-5" />,
    <FileText key="report" className="w-5 h-5" />,
  ];
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-foreground mb-4 leading-[1.1]">
              ...
              <br />
              <span className="text-foreground/50 text-xl md:text-2xl font-medium tracking-tight">{t.tagline}</span>
            </h2>
