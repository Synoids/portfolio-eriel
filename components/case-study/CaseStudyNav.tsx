  ...
  return (
    <div className="py-12 mt-12 border-t border-foreground/10 flex flex-col md:flex-row justify-between items-center gap-6">
      <Link 
        ...
        className="flex items-center gap-4 group w-full md:w-auto hover:bg-foreground/5 p-4 rounded-xl transition-colors"
      >
        <ArrowLeft size={20} className="text-foreground/40 group-hover:text-foreground group-hover:-translate-x-1 transition-all" />
      ...
      <Link 
        href="/#projects"
        className="p-3 rounded-full border border-foreground/10 text-foreground/50 hover:text-foreground hover:bg-foreground/5 transition-colors"
      ...
      <Link 
        ...
        className="flex items-center gap-4 group w-full md:w-auto hover:bg-foreground/5 p-4 rounded-xl transition-colors text-right justify-end"
      >
        ...
        <ArrowRight size={20} className="text-foreground/40 group-hover:text-foreground group-hover:translate-x-1 transition-all" />
      </Link>
    </div>
  );
}
